# Álbum de Figurinhas Virtual - Instruções de Uso

## 📋 Visão Geral

Esta é uma aplicação interativa de Álbum de Figurinhas das Seleções de Futebol, desenvolvida com **React 19** e **Tailwind CSS 4**, integrada com a **API-Football** para fornecer dados reais de jogadores e seleções.

## 🚀 Como Usar

### Passo 1: Obter Chave de API

1. Aceda a [api-football.com](https://api-football.com)
2. Crie uma conta de programador
...
1. Abra o ficheiro `client/src/hooks/useFootballAPI.ts`
...
O plano básico gratuito da API-Football possui uma quota de **50 requisições por dia**. Recomenda-se:

1. Guardar respostas em ficheiros JSON locais durante desenvolvimento
